...
<a href="https://www.codecogs.com/eqnedit.php?latex=x\sigma&space;_pk&space;\,\,&space;\mathbf{change&space;\:&space;to}&space;\frac{\sum_{j=1}^{p-1}[x\sigma&space;_jk&space;=&space;x\sigma&space;_pk]\cdot&space;Y\sigma&space;_j&space;&plus;&space;a\cdot&space;P}&space;{\sum_{j=1}^{p-1}[x\sigma&space;_jk&space;=&space;x\sigma&space;_pk]&space;&plus;&space;a}" target="_blank"><img src="https://latex.codecogs.com/gif.latex?x\sigma&space;_pk&space;\,\,&space;\mathbf{change&space;\:&space;to}&space;\frac{\sum_{j=1}^{p-1}[x\sigma&space;_jk&space;=&space;x\sigma&space;_pk]\cdot&space;Y\sigma&space;_j&space;&plus;&space;a\cdot&space;P}&space;{\sum_{j=1}^{p-1}[x\sigma&space;_jk&space;=&space;x\sigma&space;_pk]&space;&plus;&space;a}" title="x\sigma _pk \,\, \mathbf{change \: to} \frac{\sum_{j=1}^{p-1}[x\sigma _jk = x\sigma _pk]\cdot Y\sigma _j + a\cdot P} {\sum_{j=1}^{p-1}[x\sigma _jk = x\sigma _pk] + a}" /></a>
