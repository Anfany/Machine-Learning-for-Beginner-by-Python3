...
* **分类**
  ...
  OK，整理下思路。我们需要求得**g**最大，也就是<img src="http://latex.codecogs.com/svg.latex?\frac{2}{||W||}" border="0"/>最大，也就是**||W||**最小，也就是<img src="http://latex.codecogs.com/svg.latex?\frac{1}{2}W^{2}" border="0"/>最小。
